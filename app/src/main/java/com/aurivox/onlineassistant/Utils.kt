...
object Utils {
    ...
    suspend fun interpretToIntent(raw: String): ParsedIntent = withContext(Dispatchers.IO) {
        val system = """
            ...
            Actions include OPEN_APP, YOUTUBE_SEARCH, WHATSAPP_CHAT, WIFI_PANEL, BT_SETTINGS, AIRPLANE_SETTINGS, BATTERY_SAVER_SETTINGS,
            FLASHLIGHT_ON/FLASHLIGHT_OFF/FLASHLIGHT_TOGGLE, DISPLAY_SETTINGS, VOLUME_SET, NOTIFICATION_SETTINGS, SCREENSHOT_HINT, LOCK_HINT,
